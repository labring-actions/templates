...
Generated: 2026-07-20 03:59:21 UTC
...
| Reactive-Resume | `amruthpillai/reactive-resume:v4.1.2` | `amruthpillai/reactive-resume:v5.2.3` | update | high | newer compatible semver tag found | crane ls |
| Reactive-Resume | `bitnamilegacy/postgresql:latest` |  | manual | low | floating or missing tag requires manual pinning | image tag |
| Reactive-Resume | `ghcr.io/browserless/chromium:v2.11.0` | `ghcr.io/browserless/chromium:v2.55.0` | update | high | newer compatible semver tag found | crane ls |
...
| affine | `ghcr.io/toeverything/affine:0.26.7` | `ghcr.io/toeverything/affine:0.27.1` | update | high | newer compatible semver tag found | crane ls |
...
| airbyte | `airbyte/bootloader:2.1.0` | `airbyte/bootloader:2.1.1` | update | high | newer compatible semver tag found | crane ls |
| airbyte | `airbyte/cron:2.1.0` | `airbyte/cron:2.1.1` | update | high | newer compatible semver tag found | crane ls |
| airbyte | `airbyte/server:2.1.0` | `airbyte/server:2.1.1` | update | high | newer compatible semver tag found | crane ls |
| airbyte | `airbyte/worker:2.1.0` | `airbyte/worker:2.1.1` | update | high | newer compatible semver tag found | crane ls |
...
| apitable | `nginx:1.31.2-alpine` | `nginx:1.31.3-alpine` | update | high | newer compatible semver tag found | crane ls |
| apitable | `rabbitmq:4.3.2-management` |  | skip | high | no newer compatible tag found | crane ls |
| appflowy | `appflowyinc/appflowy_cloud:0.16.5` |  | skip | high | no newer compatible tag found | crane ls |
| appflowy | `appflowyinc/appflowy_web:0.15.5` |  | skip | high | no newer compatible tag found | crane ls |
| appflowy | `appflowyinc/appflowy_worker:0.16.5` |  | skip | high | no newer compatible tag found | crane ls |
| appflowy | `appflowyinc/gotrue:0.16.5` |  | skip | high | no newer compatible tag found | crane ls |
| appflowy | `busybox:1.37.0` | `busybox:1.38.0` | update | high | newer compatible semver tag found | crane ls |
| appflowy | `minio/minio:RELEASE.2025-09-07T16-13-09Z` |  | manual | low | unsupported tag family | tag parser |
| appflowy | `openresty/openresty:1.27.1.2-0-alpine@sha256:acbf6c163eef0312e624dc8c24edc7e2f1d33bca77a9e4793714d8e4affab5c5` |  | manual | low | unsupported tag family | tag parser |
...
| appwrite | `appwrite/console:7.8.26` | `appwrite/console:8.7.28` | update | high | newer compatible semver tag found | crane ls |
...
| authentik | `ghcr.io/goauthentik/server:2025.12.3` | `ghcr.io/goauthentik/server:2026.5.5` | update | high | newer compatible semver tag found | crane ls |
...
| budibase | `budibase/apps:3.15.0` | `budibase/apps:3.39.31` | update | high | newer compatible semver tag found | crane ls |
| budibase | `budibase/couchdb:v3.3.3-sqs-v2.1.1` |  | skip | high | no newer compatible tag found | crane ls |
| budibase | `budibase/proxy:3.15.0` | `budibase/proxy:3.39.31` | update | high | newer compatible semver tag found | crane ls |
| budibase | `budibase/worker:3.15.0` | `budibase/worker:3.39.31` | update | high | newer compatible semver tag found | crane ls |
| budibase | `busybox:1.37.0` | `busybox:1.38.0` | update | high | newer compatible semver tag found | crane ls |
| bunkerweb | `docker.io/bunkerity/bunkerweb-scheduler:1.6.11` | `docker.io/bunkerity/bunkerweb-scheduler:1.6.13` | update | high | newer compatible semver tag found | crane ls |
| bunkerweb | `docker.io/bunkerity/bunkerweb-ui:1.6.11` | `docker.io/bunkerity/bunkerweb-ui:1.6.13` | update | high | newer compatible semver tag found | crane ls |
| bunkerweb | `docker.io/bunkerity/bunkerweb:1.6.11` | `docker.io/bunkerity/bunkerweb:1.6.13` | update | high | newer compatible semver tag found | crane ls |
...
| bytebase | `bytebase/bytebase:3.6.1` | `bytebase/bytebase:3.20.1` | update | high | newer compatible semver tag found | crane ls |
...
| changedetection | `ghcr.io/dgtlmoon/changedetection.io:0.50.43` | `ghcr.io/dgtlmoon/changedetection.io:0.55.8` | update | high | newer compatible semver tag found | crane ls |
...
| chatgpt-next-web | `yidadaa/chatgpt-next-web:v2.16.1` |  | skip | high | no newer compatible tag found | crane ls |
...
| chatwoot | `chatwoot/chatwoot:v4.7.0` | `chatwoot/chatwoot:v4.16.0` | update | high | newer compatible semver tag found | crane ls |
...
| code-server | `codercom/code-server:4.128.0@sha256:bd4a3a022ff016954bf9ae6ea0bce6c7eef96a69da4d2fe34552638f32d4820c` | `codercom/code-server:4.129.0` | update | high | newer compatible semver tag found | crane ls |
...
| coze-studio | `milvusdb/milvus:v2.5.10` | `milvusdb/milvus:v2.6.20` | update | high | newer compatible semver tag found | crane ls |
...
| crawl4ai | `unclecode/crawl4ai:0.9.1` | `unclecode/crawl4ai:0.9.2` | update | high | newer compatible semver tag found | crane ls |
...
| dify | `langgenius/dify-api:1.15.0` | `langgenius/dify-api:1.16.0` | update | high | newer compatible semver tag found | crane ls |
| dify | `langgenius/dify-plugin-daemon:0.6.3-local` | `langgenius/dify-plugin-daemon:0.6.4-local` | update | high | newer compatible semver tag found | crane ls |
| dify | `langgenius/dify-sandbox:0.2.15` |  | skip | high | no newer compatible tag found | crane ls |
| dify | `langgenius/dify-web:1.15.0` | `langgenius/dify-web:1.16.0` | update | high | newer compatible semver tag found | crane ls |
| dify | `postgres:16-alpine` |  | manual | low | unsupported tag family | tag parser |
...
| docuseal | `docuseal/docuseal:3.0.1` | `docuseal/docuseal:3.1.4` | update | high | newer compatible semver tag found | crane ls |
...
| edgequake | `ghcr.io/raphaelmansuy/edgequake-frontend:0.12.2` | `ghcr.io/raphaelmansuy/edgequake-frontend:0.19.0` | update | high | newer compatible semver tag found | crane ls |
| edgequake | `ghcr.io/raphaelmansuy/edgequake:0.12.2` | `ghcr.io/raphaelmansuy/edgequake:0.19.0` | update | high | newer compatible semver tag found | crane ls |
...
| elasticsearch | `docker.elastic.co/elasticsearch/elasticsearch:9.4.3` |  | blocked | low | crane ls timed out after 20s | crane ls |
| elasticsearch | `nginxinc/nginx-unprivileged:1.30.3-alpine-slim` | `nginxinc/nginx-unprivileged:1.31.3-alpine-slim` | update | high | newer compatible semver tag found | crane ls |
...
| erpnext | `frappe/erpnext:v16.21.1` | `frappe/erpnext:v16.28.0` | update | high | newer compatible semver tag found | crane ls |
...
| fastgpt | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-code-sandbox:v4.14.22` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-code-sandbox:v4.15.3` | update | high | newer compatible semver tag found | crane ls |
...
| fastgpt | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-plugin:v0.6.2` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-plugin:v1.0.2` | update | high | newer compatible semver tag found | crane ls |
| fastgpt | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt:v4.14.22` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt:v4.15.3` | update | high | newer compatible semver tag found | crane ls |
| fastgpt | `registry.cn-hangzhou.aliyuncs.com/labring/aiproxy:v0.5.8` | `registry.cn-hangzhou.aliyuncs.com/labring/aiproxy:v0.6.6` | update | high | newer compatible semver tag found | crane ls |
| fastgpt-milvus | `postgres:16-alpine` |  | manual | low | unsupported tag family | tag parser |
| fastgpt-milvus | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-code-sandbox:v4.14.22` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-code-sandbox:v4.15.3` | update | high | newer compatible semver tag found | crane ls |
...
| fastgpt-milvus | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-plugin:v0.6.2` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-plugin:v1.0.2` | update | high | newer compatible semver tag found | crane ls |
| fastgpt-milvus | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt:v4.14.22` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt:v4.15.3` | update | high | newer compatible semver tag found | crane ls |
| fastgpt-milvus | `registry.cn-hangzhou.aliyuncs.com/labring/aiproxy:v0.5.8` | `registry.cn-hangzhou.aliyuncs.com/labring/aiproxy:v0.6.6` | update | high | newer compatible semver tag found | crane ls |
| fastgpt-pro | `postgres:16-alpine` |  | manual | low | unsupported tag family | tag parser |
| fastgpt-pro | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-code-sandbox:v4.14.22` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-code-sandbox:v4.15.3` | update | high | newer compatible semver tag found | crane ls |
...
| fastgpt-pro | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-plugin:v0.6.2` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-plugin:v1.0.2` | update | high | newer compatible semver tag found | crane ls |
| fastgpt-pro | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-pro:v4.14.22` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt-pro:v4.15.3` | update | high | newer compatible semver tag found | crane ls |
| fastgpt-pro | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt:v4.14.22` | `registry.cn-hangzhou.aliyuncs.com/fastgpt/fastgpt:v4.15.3` | update | high | newer compatible semver tag found | crane ls |
| fastgpt-pro | `registry.cn-hangzhou.aliyuncs.com/labring/aiproxy:v0.5.8` | `registry.cn-hangzhou.aliyuncs.com/labring/aiproxy:v0.6.6` | update | high | newer compatible semver tag found | crane ls |
| featbit-standard | `featbit/featbit-api-server:5.0.5` | `featbit/featbit-api-server:5.4.4` | update | high | newer compatible semver tag found | crane ls |
| featbit-standard | `featbit/featbit-data-analytics-server:5.0.5` | `featbit/featbit-data-analytics-server:5.4.4` | update | high | newer compatible semver tag found | crane ls |
| featbit-standard | `featbit/featbit-evaluation-server:5.0.5` | `featbit/featbit-evaluation-server:5.4.4` | update | high | newer compatible semver tag found | crane ls |
| featbit-standard | `featbit/featbit-ui:5.0.5` | `featbit/featbit-ui:5.4.4` | update | high | newer compatible semver tag found | crane ls |
...
| ghost | `ghost:6.44.1-alpine` | `ghost:6.53.0-alpine` | update | high | newer compatible semver tag found | crane ls |
...
| gitea | `gitea/gitea:1.22.0-rootless` | `gitea/gitea:1.27.0-rootless` | update | high | newer compatible semver tag found | crane ls |
...
| grafana-otel | `prom/prometheus:v3.8.0` | `prom/prometheus:v3.13.1` | update | high | newer compatible semver tag found | crane ls |
...
| immich | `ghcr.io/immich-app/immich-server:v2.7.5` | `ghcr.io/immich-app/immich-server:v3.0.3` | update | high | newer compatible semver tag found | crane ls |
...
| kaneo | `ghcr.io/usekaneo/api:1.1.8` | `ghcr.io/usekaneo/api:2.9.8` | update | high | newer compatible semver tag found | crane ls |
| kaneo | `ghcr.io/usekaneo/web:1.1.8` | `ghcr.io/usekaneo/web:2.9.8` | update | high | newer compatible semver tag found | crane ls |
...
| keycloak | `quay.io/keycloak/keycloak:26.3.2` | `quay.io/keycloak/keycloak:26.7.0` | update | high | newer compatible semver tag found | crane ls |
| keystone | `node:22.22.1-alpine` | `node:26.5.0-alpine` | update | high | newer compatible semver tag found | crane ls |
...
| kuvasz | `kuvaszmonitoring/kuvasz:3.11.0` | `kuvaszmonitoring/kuvasz:4.1.0` | update | high | newer compatible semver tag found | crane ls |
...
| laf | `quay.io/prometheus/prometheus:v2.45.0` | `quay.io/prometheus/prometheus:v3.13.1` | update | high | newer compatible semver tag found | crane ls |
...
| langfuse | `docker.io/langfuse/langfuse-worker:3.180.0` | `docker.io/langfuse/langfuse-worker:3.221.1` | update | high | newer compatible semver tag found | crane ls |
| langfuse | `docker.io/langfuse/langfuse:3.180.0` | `docker.io/langfuse/langfuse:3.221.1` | update | high | newer compatible semver tag found | crane ls |
...
| liebianbao | `nginx:1.25.2` | `nginx:1.31.3` | update | high | newer compatible semver tag found | crane ls |
...
| litellm | `litellm/litellm-database:v1.88.1` | `litellm/litellm-database:v1.93.0` | update | high | newer compatible semver tag found | crane ls |
...
| llmgateway | `ghcr.io/theopenco/llmgateway-api:v1.3.0` | `ghcr.io/theopenco/llmgateway-api:v1.8.0` | update | high | newer compatible semver tag found | crane ls |
| llmgateway | `ghcr.io/theopenco/llmgateway-docs:v1.3.0` | `ghcr.io/theopenco/llmgateway-docs:v1.8.0` | update | high | newer compatible semver tag found | crane ls |
| llmgateway | `ghcr.io/theopenco/llmgateway-gateway:v1.3.0` | `ghcr.io/theopenco/llmgateway-gateway:v1.8.0` | update | high | newer compatible semver tag found | crane ls |
| llmgateway | `ghcr.io/theopenco/llmgateway-ui:v1.3.0` | `ghcr.io/theopenco/llmgateway-ui:v1.8.0` | update | high | newer compatible semver tag found | crane ls |
| llmgateway | `ghcr.io/theopenco/llmgateway-worker:v1.3.0` | `ghcr.io/theopenco/llmgateway-worker:v1.8.0` | update | high | newer compatible semver tag found | crane ls |
...
| lobehub | `lobehub/lobehub:2.2.10@sha256:806c52b9dfac1d419de914fdc60ac386d79349663abda8566b0d077402a0049b` |  | skip | high | no newer compatible tag found | crane ls |
| lobehub | `minio/mc:RELEASE.2025-05-21T01-59-54Z` |  | manual | low | unsupported tag family | tag parser |
| lobehub | `postgres:16.14-alpine3.24` |  | manual | low | unsupported tag family | tag parser |
| lobehub | `redis:7.2.7-alpine` | `redis:8.8.0-alpine` | update | high | newer compatible semver tag found | crane ls |
...
| matomo | `matomo:5.10.0-apache` | `matomo:5.12.0-apache` | update | high | newer compatible semver tag found | crane ls |
...
| metabase | `metabase/metabase:v0.61.3` | `metabase/metabase:v0.63.1` | update | high | newer compatible semver tag found | crane ls |
...
| n8n | `alpine:3.20` |  | manual | low | unsupported tag family | tag parser |
| n8n | `busybox:1.36` |  | manual | low | unsupported tag family | tag parser |
| n8n | `n8nio/n8n:2.22.4` | `n8nio/n8n:2.31.3` | update | high | newer compatible semver tag found | crane ls |
| n8n | `n8nio/runners:2.22.4` | `n8nio/runners:2.31.3` | update | high | newer compatible semver tag found | crane ls |
...
| nacos | `nacos/nacos-server:v3.2.2` | `nacos/nacos-server:v3.2.3` | update | high | newer compatible semver tag found | crane ls |
| nakama | `busybox:1.36` |  | manual | low | unsupported tag family | tag parser |
| nakama | `heroiclabs/nakama:3.39.0` | `heroiclabs/nakama:3.40.0` | update | high | newer compatible semver tag found | crane ls |
| nakama | `postgres:16-alpine` |  | manual | low | unsupported tag family | tag parser |
| netbird | `netbirdio/dashboard:v2.38.1` | `netbirdio/dashboard:v2.90.4` | update | high | newer compatible semver tag found | crane ls |
| netbird | `netbirdio/management:0.71.4` | `netbirdio/management:0.74.7` | update | high | newer compatible semver tag found | crane ls |
| netbird | `netbirdio/relay:0.71.4` | `netbirdio/relay:0.74.7` | update | high | newer compatible semver tag found | crane ls |
| netbird | `netbirdio/signal:0.71.4` | `netbirdio/signal:0.74.7` | update | high | newer compatible semver tag found | crane ls |
...
| nexus | `sonatype/nexus3:3.92.3` | `sonatype/nexus3:3.94.0` | update | high | newer compatible semver tag found | crane ls |
| nocodb | `nocodb/nocodb:2026.06.2` | `nocodb/nocodb:2026.07.0` | update | medium | newer compatible date tag found | crane ls |
...
| odysseus | `binwiederhier/ntfy:v2.26.0` |  | skip | high | no newer compatible tag found | crane ls |
| odysseus | `busybox:1.36.1` | `busybox:1.38.0` | update | high | newer compatible semver tag found | crane ls |
| odysseus | `chromadb/chroma:1.5.9` |  | skip | high | no newer compatible tag found | crane ls |
| odysseus | `ghcr.io/pewdiepie-archdaemon/odysseus:1.0.2@sha256:80ed3a1c17fd08e95d12fc709889905aca47f51fa3524b07b53d692d25639879` |  | skip | high | no newer compatible tag found | crane ls |
...
| open-webui | `openwebui/open-webui:0.10.2` |  | skip | high | no newer compatible tag found | crane ls |
| open-webui | `public.ecr.aws/docker/library/postgres:16.4-alpine` |  | manual | low | unsupported tag family | tag parser |
...
| openclaw | `openclaw/openclaw:2026.6.11-slim` | `openclaw/openclaw:2026.7.1-slim` | update | high | newer compatible semver tag found | crane ls |
...
| openobserve | `public.ecr.aws/zinclabs/openobserve:v0.90.3` | `public.ecr.aws/zinclabs/openobserve:v0.91.2` | update | high | newer compatible semver tag found | crane ls |
| outline | `outlinewiki/outline:1.8.0-1` | `outlinewiki/outline:1.9.2-0` | update | high | newer compatible semver tag found | crane ls |
...
| palacms | `ghcr.io/palacms/palacms:v3.0.0-beta.1` |  | blocked | low | 2026/07/20 11:58:56 No matching credentials were found for "ghcr.io"
...
| pangolin | `docker.io/fosrl/pangolin:1.15.2` | `docker.io/fosrl/pangolin:1.20.0` | update | high | newer compatible semver tag found | crane ls |
...
| pocket-id | `ghcr.io/pocket-id/pocket-id:v2.2.0` | `ghcr.io/pocket-id/pocket-id:v2.11.0` | update | high | newer compatible semver tag found | crane ls |
| pocketbase | `adrianmusante/pocketbase:0.29.3` | `adrianmusante/pocketbase:0.39.8` | update | high | newer compatible semver tag found | crane ls |
...
| posthog | `docker.redpanda.com/redpandadata/redpanda:v25.1.9` | `docker.redpanda.com/redpandadata/redpanda:v26.1.13` | update | high | newer compatible semver tag found | crane ls |
...
| presenton | `ghcr.io/presenton/presenton:v0.8.2-beta` | `ghcr.io/presenton/presenton:v0.9.1-beta` | update | high | newer compatible semver tag found | crane ls |
...
| privatebin | `ghcr.io/privatebin/fs:1.7.4` | `ghcr.io/privatebin/fs:2.0.5` | update | high | newer compatible semver tag found | crane ls |
...
| rclone | `rclone/rclone:1.74.3` | `rclone/rclone:1.74.4` | update | high | newer compatible semver tag found | crane ls |
...
| rocketchat | `registry.rocket.chat/rocketchat/rocket.chat:7.9.0` | `registry.rocket.chat/rocketchat/rocket.chat:8.6.1` | update | high | newer compatible semver tag found | crane ls |
...
| rocketchat-micro | `rocketchat/account-service:7.9.0` | `rocketchat/account-service:8.6.1` | update | high | newer compatible semver tag found | crane ls |
| rocketchat-micro | `rocketchat/authorization-service:7.9.0` | `rocketchat/authorization-service:8.6.1` | update | high | newer compatible semver tag found | crane ls |
| rocketchat-micro | `rocketchat/ddp-streamer-service:7.9.0` | `rocketchat/ddp-streamer-service:8.6.1` | update | high | newer compatible semver tag found | crane ls |
| rocketchat-micro | `rocketchat/presence-service:7.9.0` | `rocketchat/presence-service:8.6.1` | update | high | newer compatible semver tag found | crane ls |
| rocketchat-micro | `rocketchat/rocket.chat:7.9.0` | `rocketchat/rocket.chat:8.6.1` | update | high | newer compatible semver tag found | crane ls |
...
| rsshub | `diygod/rsshub:2024-07-06` | `diygod/rsshub:2026-07-19` | update | medium | newer compatible date tag found | crane ls |
...
| s-pdf | `docker.io/stirlingtools/stirling-pdf:2.14.2-fat` |  | skip | high | no newer compatible tag found | crane ls |
| s-pdf | `postgres:16-alpine` |  | manual | low | unsupported tag family | tag parser |
...
| signoz | `signoz/signoz-otel-collector:v0.144.2` | `signoz/signoz-otel-collector:v0.144.6` | update | high | newer compatible semver tag found | crane ls |
| signoz | `signoz/signoz:v0.117.0` | `signoz/signoz:v0.133.0` | update | high | newer compatible semver tag found | crane ls |
...
| stalwart | `stalwartlabs/stalwart:v0.16.7` | `stalwartlabs/stalwart:v0.16.13` | update | high | newer compatible semver tag found | crane ls |
...
| strapi | `bitnamilegacy/kubectl:1.33.4@sha256:ed0b31a0508da84ee655c5c6e01bd3897fc56ad6cf69debb27fa1893a06d2246` |  | skip | high | no newer compatible tag found | crane ls |
| strapi | `node:22.17.1-bookworm-slim@sha256:2fa754a9ba4d7adbd2a51d182eaabbe355c82b673624035a38c0d42b08724854` | `node:26.5.0-bookworm-slim` | update | high | newer compatible semver tag found | crane ls |
| strapi | `postgres:16.4-alpine3.20` |  | manual | low | unsupported tag family | tag parser |
| sub2api | `postgres:16-alpine` |  | manual | low | unsupported tag family | tag parser |
| sub2api | `weishaw/sub2api:0.1.104` | `weishaw/sub2api:0.1.161` | update | high | newer compatible semver tag found | crane ls |
...
| supabase | `supabase/gotrue:v2.186.0` | `supabase/gotrue:v2.193.0` | update | high | newer compatible semver tag found | crane ls |
| supabase | `supabase/logflare:1.31.2` | `supabase/logflare:1.47.1` | update | high | newer compatible semver tag found | crane ls |
...
| supabase | `supabase/realtime:v2.76.5` | `supabase/realtime:v2.116.1` | update | high | newer compatible semver tag found | crane ls |
| supabase | `supabase/storage-api:v1.37.8` | `supabase/storage-api:v1.67.5` | update | high | newer compatible semver tag found | crane ls |
| supabase | `supabase/studio:2026.02.16-sha-26c615c` | `supabase/studio:2026.07.13-sha-b5ada96` | update | medium | newer compatible date tag found | crane ls |
| supabase | `supabase/supavisor:2.7.4` | `supabase/supavisor:2.9.7` | update | high | newer compatible semver tag found | crane ls |
| supabase | `timberio/vector:0.53.0-alpine` | `timberio/vector:0.57.0-alpine` | update | high | newer compatible semver tag found | crane ls |
...
| syncthing | `syncthing/syncthing:2.1.1` | `syncthing/syncthing:2.1.2` | update | high | newer compatible semver tag found | crane ls |
...
| tolgee | `tolgee/tolgee:v3.113.0` | `tolgee/tolgee:v3.213.0` | update | high | newer compatible semver tag found | crane ls |
...
| tooljet | `tooljet/tooljet-ce:v3.20.170-lts` | `tooljet/tooljet-ce:v3.20.196-lts` | update | high | newer compatible semver tag found | crane ls |
...
| tududi | `chrisvel/tududi:1.1.0` | `chrisvel/tududi:1.2.4` | update | high | newer compatible semver tag found | crane ls |
...
| twenty | `twentycrm/twenty:v1.12.0` | `twentycrm/twenty:v2.22.0` | update | high | newer compatible semver tag found | crane ls |
| typebot | `axllent/mailpit:v1.30.1` | `axllent/mailpit:v1.30.4` | update | high | newer compatible semver tag found | crane ls |
...
| woocommerce | `wordpress:6.9.1-php8.3-apache` | `wordpress:7.0.1-php8.5-apache` | update | high | newer compatible semver tag found | crane ls |
| woocommerce | `wordpress:cli-2.9.0-php8.3` |  | manual | low | unsupported tag family | tag parser |
| wordpress | `wordpress:6.5.4` | `wordpress:7.0.1` | update | high | newer compatible semver tag found | crane ls |
...
| wrenai | `qdrant/qdrant:v1.13.4` | `qdrant/qdrant:v1.18.3` | update | high | newer compatible semver tag found | crane ls |
...
| zitadel | `ghcr.io/zitadel/zitadel:v4.10.1` | `ghcr.io/zitadel/zitadel:v4.16.1` | update | high | newer compatible semver tag found | crane ls |
...
### appflowy: `appflowyinc/appflowy_cloud:0.16.5`
- `originImageName` at `template/appflowy/index.yaml:768`
- `image` at `template/appflowy/index.yaml:871`

### appflowy: `appflowyinc/appflowy_web:0.15.5`
- `originImageName` at `template/appflowy/index.yaml:1280`
- `image` at `template/appflowy/index.yaml:1301`

### appflowy: `appflowyinc/appflowy_worker:0.16.5`
- `originImageName` at `template/appflowy/index.yaml:1061`
- `image` at `template/appflowy/index.yaml:1163`

### appflowy: `appflowyinc/gotrue:0.16.5`
- `originImageName` at `template/appflowy/index.yaml:578`
- `image` at `template/appflowy/index.yaml:648`

### appflowy: `busybox:1.37.0`
- `image` at `template/appflowy/index.yaml:838`
- `image` at `template/appflowy/index.yaml:854`
- `image` at `template/appflowy/index.yaml:1130`
- `image` at `template/appflowy/index.yaml:1146`

### appflowy: `minio/minio:RELEASE.2025-09-07T16-13-09Z`
- `originImageName` at `template/appflowy/index.yaml:230`
- `image` at `template/appflowy/index.yaml:252`

### appflowy: `openresty/openresty:1.27.1.2-0-alpine@sha256:acbf6c163eef0312e624dc8c24edc7e2f1d33bca77a9e4793714d8e4affab5c5`
- `originImageName` at `template/appflowy/index.yaml:134`
- `image` at `template/appflowy/index.yaml:154`

### appflowy: `postgres:16.4-alpine`
- `image` at `template/appflowy/index.yaml:600`
- `image` at `template/appflowy/index.yaml:791`
- `image` at `template/appflowy/index.yaml:1083`
...
### code-server: `codercom/code-server:4.128.0@sha256:bd4a3a022ff016954bf9ae6ea0bce6c7eef96a69da4d2fe34552638f32d4820c`
- `originImageName` at `template/code-server/index.yaml:62`
- `image` at `template/code-server/index.yaml:93`
...
### crawl4ai: `unclecode/crawl4ai:0.9.1`
- `originImageName` at `template/crawl4ai/index.yaml:46`
- `image` at `template/crawl4ai/index.yaml:76`
- `image` at `template/crawl4ai/index.yaml:120`
...
### dify: `busybox:1.37.0`
- `image` at `template/dify/index.yaml:509`

### dify: `langgenius/dify-api:1.15.0`
- `originImageName` at `template/dify/index.yaml:443`
- `image` at `template/dify/index.yaml:535`
- `image` at `template/dify/index.yaml:722`
- `image` at `template/dify/index.yaml:885`

### dify: `langgenius/dify-plugin-daemon:0.6.3-local`
- `originImageName` at `template/dify/index.yaml:1397`
- `image` at `template/dify/index.yaml:1464`

### dify: `langgenius/dify-sandbox:0.2.15`
- `originImageName` at `template/dify/index.yaml:1313`
- `image` at `template/dify/index.yaml:1336`

### dify: `langgenius/dify-web:1.15.0`
- `originImageName` at `template/dify/index.yaml:1061`
- `image` at `template/dify/index.yaml:1125`

### dify: `postgres:16-alpine`
- `image` at `template/dify/index.yaml:163`
- `image` at `template/dify/index.yaml:467`
- `image` at `template/dify/index.yaml:1082`
- `image` at `template/dify/index.yaml:1421`

### dify: `semitechnologies/weaviate:1.27.0`
- `originImageName` at `template/dify/index.yaml:320`
- `image` at `template/dify/index.yaml:342`
...
- `image` at `template/elasticsearch/index.yaml:176`

### elasticsearch: `docker.elastic.co/elasticsearch/elasticsearch:9.4.3`
- `originImageName` at `template/elasticsearch/index.yaml:148`
- `image` at `template/elasticsearch/index.yaml:197`

### elasticsearch: `nginxinc/nginx-unprivileged:1.30.3-alpine-slim`
- `originImageName` at `template/elasticsearch/index.yaml:348`
- `image` at `template/elasticsearch/index.yaml:371`
...
- `image` at `template/firecrawl/index.yaml:288`
- `image` at `template/firecrawl/index.yaml:743`

### firecrawl: `ghcr.io/firecrawl/firecrawl@sha256:3eee4a4059d78da747fc04db4649b35c0f2cdd50cb618a8e444b2e7f256b583c`
- `originImageName` at `template/firecrawl/index.yaml:484`
- `image` at `template/firecrawl/index.yaml:769`

### firecrawl: `ghcr.io/firecrawl/playwright-service@sha256:f5ee76305462a3e43daf3f4f4fe2d63b57a13acc2d115214629e8feb888b289e`
- `originImageName` at `template/firecrawl/index.yaml:396`
- `image` at `template/firecrawl/index.yaml:421`

### firecrawl: `public.ecr.aws/docker/library/postgres:16.4-alpine`
- `image` at `template/firecrawl/index.yaml:510`

### firecrawl: `rabbitmq:3.13.7-management`
- `originImageName` at `template/firecrawl/index.yaml:260`
- `image` at `template/firecrawl/index.yaml:317`

### firecrawl: `redis:7.2.7-alpine`
- `image` at `template/firecrawl/index.yaml:711`
...
### lobehub: `lobehub/lobehub:2.2.10@sha256:806c52b9dfac1d419de914fdc60ac386d79349663abda8566b0d077402a0049b`
- `originImageName` at `template/lobehub/index.yaml:593`
- `image` at `template/lobehub/index.yaml:785`

### lobehub: `minio/mc:RELEASE.2025-05-21T01-59-54Z`
- `image` at `template/lobehub/index.yaml:726`

### lobehub: `postgres:16.14-alpine3.24`
- `image` at `template/lobehub/index.yaml:313`
- `image` at `template/lobehub/index.yaml:617`

### lobehub: `redis:7.2.7-alpine`
- `image` at `template/lobehub/index.yaml:679`
...
### n8n: `alpine:3.20`
- `image` at `template/n8n/index.yaml:376`

### n8n: `busybox:1.36`
- `image` at `template/n8n/index.yaml:667`

### n8n: `n8nio/n8n:2.22.4`
- `originImageName` at `template/n8n/index.yaml:352`
- `image` at `template/n8n/index.yaml:436`
- `originImageName` at `template/n8n/index.yaml:647`
- `image` at `template/n8n/index.yaml:686`

### n8n: `n8nio/runners:2.22.4`
- `originImageName` at `template/n8n/index.yaml:588`
- `image` at `template/n8n/index.yaml:608`
- `originImageName` at `template/n8n/index.yaml:773`
- `image` at `template/n8n/index.yaml:793`

### n8n: `postgres:16-alpine`
- `image` at `template/n8n/index.yaml:296`
- `image` at `template/n8n/index.yaml:391`
...
### nocodb: `nocodb/nocodb:2026.06.2`
- `originImageName` at `template/nocodb/index.yaml:156`
- `image` at `template/nocodb/index.yaml:180`
...
### odysseus: `binwiederhier/ntfy:v2.26.0`
- `originImageName` at `template/odysseus/index.yaml:287`
- `image` at `template/odysseus/index.yaml:308`

### odysseus: `busybox:1.36.1`
- `image` at `template/odysseus/index.yaml:409`
- `image` at `template/odysseus/index.yaml:431`

### odysseus: `chromadb/chroma:1.5.9`
- `originImageName` at `template/odysseus/index.yaml:85`
- `image` at `template/odysseus/index.yaml:106`

### odysseus: `ghcr.io/pewdiepie-archdaemon/odysseus:1.0.2@sha256:80ed3a1c17fd08e95d12fc709889905aca47f51fa3524b07b53d692d25639879`
- `originImageName` at `template/odysseus/index.yaml:385`
- `image` at `template/odysseus/index.yaml:454`

### odysseus: `searxng/searxng:2026.5.31-7159b8aed`
- `originImageName` at `template/odysseus/index.yaml:181`
- `image` at `template/odysseus/index.yaml:202`
...
### open-webui: `openwebui/open-webui:0.10.2`
- `originImageName` at `template/open-webui/index.yaml:228`
- `image` at `template/open-webui/index.yaml:298`

### open-webui: `public.ecr.aws/docker/library/postgres:16.4-alpine`
- `image` at `template/open-webui/index.yaml:174`
- `image` at `template/open-webui/index.yaml:255`
...
### openclaw: `openclaw/openclaw:2026.6.11-slim`
- `originImageName` at `template/openclaw/index.yaml:173`
- `image` at `template/openclaw/index.yaml:203`
- `image` at `template/openclaw/index.yaml:243`
...
### s-pdf: `docker.io/stirlingtools/stirling-pdf:2.14.2-fat`
- `originImageName` at `template/s-pdf/index.yaml:219`
- `image` at `template/s-pdf/index.yaml:288`

### s-pdf: `postgres:16-alpine`
- `image` at `template/s-pdf/index.yaml:163`
- `image` at `template/s-pdf/index.yaml:243`
...
### strapi: `bitnamilegacy/kubectl:1.33.4@sha256:ed0b31a0508da84ee655c5c6e01bd3897fc56ad6cf69debb27fa1893a06d2246`
- `image` at `template/strapi/index.yaml:374`
- `image` at `template/strapi/index.yaml:434`

### strapi: `node:22.17.1-bookworm-slim@sha256:2fa754a9ba4d7adbd2a51d182eaabbe355c82b673624035a38c0d42b08724854`
- `originImageName` at `template/strapi/index.yaml:745`
- `image` at `template/strapi/index.yaml:828`
- `image` at `template/strapi/index.yaml:942`
- `image` at `template/strapi/index.yaml:983`

### strapi: `postgres:16.4-alpine3.20`
- `image` at `template/strapi/index.yaml:193`
- `image` at `template/strapi/index.yaml:774`
