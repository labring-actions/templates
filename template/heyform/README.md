...
This Sealos template deploys **HeyForm** as the `heyform` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
...
- Source repository: https://github.com/heyform/heyform
