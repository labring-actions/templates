...
This Sealos template deploys **Bytebase** as the `bytebase` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
...
- Official website: https://bytebase.com/
