...
This Sealos template deploys **Headscale** as the `headscale` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
