...
This Sealos template deploys **Payload** as the `payload` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
...
- Source repository: https://github.com/payloadcms/payload
