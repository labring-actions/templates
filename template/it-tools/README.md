...
This Sealos template deploys **IT-Tools** as the `it-tools` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
