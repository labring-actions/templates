...
This Sealos template deploys **Fireboom** as the `fireboom` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
...
- Source repository: https://github.com/fireboomio
