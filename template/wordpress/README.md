...
This Sealos template deploys **WordPress** as the `wordpress` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
...
- Source repository: https://github.com/WordPress/WordPress
