...
This Sealos template deploys **registry** as the `registry` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
...
- Source repository: https://github.com/distribution/distribution
