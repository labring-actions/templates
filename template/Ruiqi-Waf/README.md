...
This Sealos template deploys **Ruiqi-Waf** as the `Ruiqi-Waf` application. It uses the repository-maintained Sealos manifest and keeps deployment, networking, and storage configuration inside the template.
...
- Official website: https://github.com/labring/RuiQi
- Source repository: https://github.com/labring/RuiQi
